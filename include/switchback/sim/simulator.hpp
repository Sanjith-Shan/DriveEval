#ifndef SWITCHBACK_SIM_SIMULATOR_HPP
#define SWITCHBACK_SIM_SIMULATOR_HPP
...
struct SimConfig {
  ...
  // Ablation knobs. Used by sb_ablate to attribute a failure to a cause, and
...
#endif  // SWITCHBACK_SIM_SIMULATOR_HPP
