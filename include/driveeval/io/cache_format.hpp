// DriveEval scenario cache -- binary layout.
//
...
// Python writer in python/driveeval/cache.py mirrors these definitions and
...
#ifndef DRIVEEVAL_IO_CACHE_FORMAT_HPP
#define DRIVEEVAL_IO_CACHE_FORMAT_HPP
...
#endif  // DRIVEEVAL_IO_CACHE_FORMAT_HPP
