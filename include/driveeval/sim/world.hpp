#ifndef DRIVEEVAL_SIM_WORLD_HPP
#define DRIVEEVAL_SIM_WORLD_HPP
...
struct ReactiveParams {
  ...
  // sensitivity of the headline to them can be measured, which drive_sweep does.
  Scalar a_max{1.5};
