"""Build the Switchback HTML report from the results store.
...
from switchback.report.assets import CSS, PALETTE, SEQUENTIAL, chart_rc, fig_to_data_uri
from switchback.viz.render import load_traj, render_failure_grid
...
def _default_limitations_paths() -> tuple[Path, ...]:
    # python/switchback/report/build.py -> repo root is three parents up.
...
<title>Switchback evaluation report</title>
<style>{CSS}</style>
</head><body><div class="sheet">
<p class="eyebrow">Switchback</p>
...
switchback.report.build. Self-contained: styles are inline, every figure is an
