"""Argoverse 2 motion-forecasting -> Switchback scenario cache.

One AV2 scenario is a parquet of (track, timestep) rows plus a JSON map
archive. This turns that pair into one switchback.cache.Scenario. The cache
layout is a locked contract (include/switchback/io/cache_format.hpp); nothing
