...
Two deliberate divergences from Dyno, both because Switchback's data is shaped
differently:

1. **Dyno compares two independently bootstrapped medians and asks whether the
   intervals overlap. Switchback bootstraps the paired delta and asks whether
...
def gate(
    ...
    *,
    ...
    fails the gate; Switchback's locked schema has only three verdict strings,
