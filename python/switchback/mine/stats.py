"""Resampling and multiple-comparison machinery for Switchback.
...
string that says so; Switchback does the same rather than raising, because a
...
def cluster_bootstrap(
    ...
    *,
    ...
    drawn cluster comes along. This is the correct unit for Switchback because
