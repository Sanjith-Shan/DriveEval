...
from driveeval.report.assets import PALETTE, chart_rc
...
def render_scenario(
    ...
    *,
    ...
    The axes carries the resulting `RenderStats` as `ax.driveeval_stats`.
    """
    ...
    ax.driveeval_stats = stats  # type: ignore[attr-defined]
    return ax
